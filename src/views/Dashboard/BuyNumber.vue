...
<template>
    <div class="pl-[7px]">
        ...
        <div>
            <h1 class="text-neutral-800 text-left text-[24px] font-medium font-['Poppins'] leading-[17px]">To Get A Number
            </h1>
            <p class="text-neutral-800 text-left text-base font-light font-['Poppins'] leading-[11px] mt-[20px]">for any kind
                of services</p>
        ...
        <div>
            <ul
                ...
                <li class="-mb-px last:mr-0 flex-auto text-center cursor-pointer">
                    <a class="w-[117px] flex items-center justify-center text-center text-sm font-light font-['Poppins'] leading-[13px] px-5 pt-2 pb-3 h-[53px] "
    ...
    <div class="flex flex-wrap ">
        <div class="w-full">
            ...
            <div
                class="w-full mt-[0px] px-[0px] pb-[30px] flex-col justify-start items-center gap-[30px] inline-flex">
                <div class="w-full">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- <img class="w-[30px] h-[30px] rounded-full"
                                                                :src="PhilipinsImg" /> -->
                                                            <div
                                                                class="grow shrink basis-0 text-neutral-800 text-sm font-light font-['Poppins']">
                                                                {{ country.name }}</div>
                                                        </div>
                                                    </div>
                ...
                alt="Flag" /> -->
                                                        ...
                                                        <div
                                                            class="text-right text-neutral-800 text-sm font-light font-['Poppins']">
                                                            {{ service.price }}</div>
                                                    </div>
                                                ...
                                                <li v-for="(phoneNumber, index) in filteredPhone" :key="index"
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="grow shrink basis-0 text-neutral-800 text-sm font-light font-['Poppins'] flex flex-col gap-[16px]">
                                                                {{ phoneNumber }}
                                                ...
                                                <li v-for="(phoneNumber, index) in filteredPhone" :key="index"
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="grow shrink basis-0 text-neutral-800 text-sm font-light font-['Poppins'] flex items-center gap-[16px]">
                                                                {{ phoneNumber }}
                                                                <div v-if="selectedPhone === phoneNumber"
...
<script>
import WeekListDropdown from '../../components/WeekListDropdown/WeekListDropdown.vue';
