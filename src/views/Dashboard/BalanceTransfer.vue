            ...
            <div class="max-w-[450px] min-w-[350px] w-full h-96 px-3 lg:px-[30px] py-10 bg-white dark:bg-[#09132C] rounded-[20px] shadow-none lg:shadow-custom">
                ...
                <form v-on:submit="onSubmit">
                    <div>
                        ...
                        <input
                            class="max-w-full lg:max-w-[390px] w-full h-[50px] px-4 outline-none pt-3.5 pb-[15px] rounded-[10px] border border-zinc-600 justify-start items-center inline-flex mt-[14px] dark:bg-transparent"
