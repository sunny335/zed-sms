        ...
        <div class="flex items-center gap-4 mr-4">
          ...
          >
            ...
            <div
              ...
              class="w-[300px] lg:w-[369px] absolute z-10 right-[-128px] top-[40px] h-[630px] px-[25px] py-5 bg-neutral-50 dark:bg-slate-800 rounded-[30px] flex-col justify-start items-start gap-3.5 inline-flex"
            >
              <div
