...
<template>
    <section
        ...
        <div>
            <h1 class="text-neutral-800 text-left text-2xl  lg:text-[32px] font-medium font-['Poppins'] leading-[22px]">
                Select Payment
                Source
            </h1>
                        ...
                        <div class="tab-content tab-space w-full">
                            ...
                            <div class="w-full" v-bind:class="{ 'hidden': openTab !== 1, 'block': openTab === 1 }">
                                <div class="mt-[30px] flex justify-center items-center">
                                    <div
                                        class="max-w-[376px] lg:max-w-[612px] max-h-[293px] px-[42px] py-[100px] lg:px-40 lg:py-[100px] bg-white rounded-3xl shadow-none lg:shadow-custom flex-col justify-start items-start gap-7 inline-flex">
                                        <div class="text-neutral-800 text-base font-normal font-['Poppins']">Payment
                                            with
                                            account balance</div>
                                        <div class="justify-start items-center gap-10 inline-flex">
                                            <div class="justify-start items-center gap-3.5 flex">
                                                <div class="text-zinc-600 text-xl font-medium font-['Poppins']">Cost:
                                                </div>
                                                <div class="text-zinc-600 text-xl font-normal font-['Poppins']">$32.54
                                                </div>
                                            </div>
                                            <button
                            ...
                            <div v-bind:class="{ 'hidden': openTab !== 2, 'block': openTab === 2 }">
                                <div class="">
                                                    ...
                                                    <li v-for="(payment, index) in paymentsData" :key="index"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <h5 class="text-neutral-800 text-base font-medium font-['Poppins'] leading-[17px]"
                                                                    v-bind:class="{ 'text-white': selectedPayment == payment, }">
                                                                    {{ payment.name }}</h5>
                                                                <p class=" text-neutral-800 text-sm font-light font-['Poppins'] leading-normal"
                                                                    v-bind:class="{ 'text-white': selectedPayment == payment, }">
                                                                    {{ payment.text }}</p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="flex flex-col lg:flex-row justify-center lg:justify-end items-start mt-[45px] gap-4">
                                        <input
                                            class="max-w-[358px] w-full h-16 pl-10 pr-[200px] py-3 rounded-xl border border-gray-400 justify-center items-center gap-2.5 inline-flex"
                                        ...
                                        <button v-on:click="selectNextPaymentPage(true)"
                                            class="max-w-[300px] w-full h-16 px-10 py-3.5 rounded-xl border border-blue-600 justify-center items-center gap-3.5 inline-flex"
                                            v-bind:class="{ 'hidden': nextPaymentPage == true, 'block': nextPaymentPage === false }">
                                            <div class="text-center text-blue-600 text-2xl font-normal font-['Poppins']">
                                                Next</div>
                                            <div class=" relative">
                                        ...
                                        <RouterLink to="/payment-successful"
                                            class="max-w-full lg:max-w-[150px] w-full h-16 px-10 py-3.5 rounded-xl border border-blue-600 justify-center items-center gap-3.5 inline-flex"
                                            v-bind:class="{ 'hidden': nextPaymentPage == false, 'block': nextPaymentPage === true }">
                                            <div class="text-center text-blue-600 text-2xl font-normal font-['Poppins']">
                                                Next</div>
                                            <div class=" relative">
