...
<template>
  <div>
    <h1 class="text-neutral-800 dark:text-[#F5F5F5] text-center text-[32px] font-medium font-[Poppins] leading-[22px]">
      To Get A Number
    </h1>
    <p
  ...
  <div class="flex flex-wrap mt-[30px]">
    <div class="w-full">
      <ul
        class="flex mb-0 list-none flex-row max-w-[300px] lg:max-w-[450px] w-full mx-auto rounded-2xl border border-[#0057FF] overflow-hidden h-[58px]"
  ...
  'text-white bg-[#0057FF]': openTab === 3,
      ...
      <div class="relative px-[22px] mt-[30px]  block lg:hidden">
        ...
        <div class="max-w-full overflow-x-auto scroll-hide mx-auto" ref="scrollContainer">
          <div class="items-center gap-[20px] min-h-[60px] justify-center w-max mx-auto pb-[26px] flex pl-2" ref="content"
            ...
            <div class="flex gap-[6px] items-center ">
              ...
              <div v-if="selectedCountry" class="flex gap-[6px] items-center">
                ...
                <div class="text-center text-zinc-600 dark:text-[#F5F5F5] text-[11px] font-light font-[Poppins]">
            ...
            <div class="flex gap-[6px] items-center " v-bind:class="{
              ...
              <div v-if="selectedService" class="flex gap-[6px] items-center">
                <img class="w-[20px] h-[20px] rounded-full" :src="selectedService?.flag" alt="Image Description" />
                <div class="text-center text-zinc-600 dark:text-[#F5F5F5] text-[11px] font-light font-[Poppins]">
            ...
            <div class="flex gap-[6px] items-center" v-bind:class="{
              ...
              <div v-if="selectedPhone" class="text-zinc-600 text-[11px] dark:text-[#F5F5F5] font-light font-[Poppins]">
                {{ selectedPhone }}
              </div>
            </div>
            <!-- <div
          ...
          <div class="tab-content tab-space w-full">
            <div
              ...
              <div class="flex gap-[6px] items-center" v-bind:class="{
                ...
                <div v-if="selectedService" class="flex gap-[6px] items-center">
                  <img class="w-[30px] h-[30px] rounded-full" :src="selectedService?.flag" alt="Image Description" />
                  <div class="text-center text-zinc-600 dark:text-[#F5F5F5] text-sm font-light font-[Poppins]">
                    {{ selectedService?.name }}
                  </div>
                </div>
              ...
              <div class="flex gap-[6px] items-center" v-bind:class="{
                ...
                <div v-if="selectedPhone" class="text-zinc-600 text-sm dark:text-[#F5F5F5] font-light font-[Poppins]">
                  {{ selectedPhone }}
                </div>
              </div>
              ...
              <div class="flex gap-[6px] items-center" v-if="openTab === 2 ? selectedCountry?.price : selectedService">
                <div class="text-center text-zinc-600 dark:text-[#F5F5F5] text-sm font-normal font-[Poppins]">
                  Cost:
                </div>
                <div class="text-zinc-600 dark:text-[#F5F5F5] text-sm font-light font-[Poppins]">
            ...
            <div v-bind:class="{ hidden: openTab !== 1, block: openTab === 1 }" class="w-full">
              <div class="mt-[30px]">
                <div class="flex gap-4">
                  <!-- column1 -->
                  <div class="max-w-full lg:max-w-[306px] w-full" v-bind:class="{ 'hidden lg:block': selectedCountry }">
                    <form>
                      <label for="default-search"
                        class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-[#F5F5F5]">Search</label>
                      <div class="relative">
                    ...
                    <div
                      ...
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li class="mr-[13px] rounded-[14px] border-gray-400 cursor-pointer"
                          v-for="(country, index) in filteredCountries" :key="index" @click="selectCountry(country)"
                          :class="{
                            border:
                  ...
                  <!-- column2 -->
                  <div class="max-w-full lg:max-w-[306px] w-full lg:block" v-bind:class="{
                    ...
                    <p class="w-full text-end pr-[50px] pt-[10px] h-[26px] font-[Poppins]">Day</p>
                    <div
                      class="relative after:content-[''] after:w-[2px] after:absolute after:top-0 after:bottom-0 after:right-[1px] after:bg-[#DDE2E5]">
                  ...
                  <!-- column2 end -->
                  <!-- column3 -->
                  <div class="max-w-full lg:max-w-[423px] w-full lg:block" v-bind:class="{
                    ...
                    <div
                      ...
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li v-for="(phoneNumber, index) in filteredPhone" :key="index"
                          ...
                          <div class="w-full h-[54px] pl-6 pr-[30px] py-3 justify-between items-center inline-flex">
                            <div class="grow shrink basis-0 h-[30px] justify-start items-center gap-2.5 flex">
                              <div
                                ...
                                <div v-if="selectedPhone === phoneNumber"
                                  ...
                                  <div @click="handleModalOpen(true)"
                                    ...
                                    <span class=" text-xs font-normal font-[Poppins]">Get Now</span>
                                    <svg class="darkIconStock" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                      ...
                                      <path d="M4.66675 7H9.33342" stroke="#495057" stroke-width="0.7"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                      <path d="M5.83325 8.75H8.16659" stroke="#495057" stroke-width="0.7"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                      <path d="M10.5 5.25L8.75 1.75" stroke="#495057" stroke-width="0.7"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                      <path d="M3.5 5.25L5.25 1.75" stroke="#495057" stroke-width="0.7"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                  </div>
                                </div>
            ...
            <div v-bind:class="{ hidden: openTab !== 2, block: openTab === 2 }">
              <div class="mt-[30px]">
                <div class="flex gap-4">
                  <div class="max-w-3/6 w-full" v-bind:class="{ 'hidden lg:block': selectedCountry }">
                    <form>
                      <label for="default-search"
                        class="mb-2 text-sm font-medium text-gray-900 dark:text-[#F5F5F5] sr-only dark:text-[#F5F5F5]">Search</label>
                      <div class="relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                          <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <p class="w-full text-end pr-[50px] pt-[10px] h-[26px]">Day</p>
                    <div
                      class="relative after:content-[''] after:w-[2px] after:absolute after:top-0 after:bottom-0 after:right-[1px] after:bg-[#DDE2E5]">
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li class="mr-[13px] rounded-[14px] border-gray-400 cursor-pointer"
                  ...
                  <div class="max-w-3/6 w-full" v-bind:class="{
                    ...
                    <p class="w-full text-end pr-[50px] pt-2 h-[26px]"></p>
                    <div
                      class="relative after:content-[''] after:w-[2px] after:absolute after:top-0 after:bottom-0 after:right-[1px] after:bg-[#DDE2E5]">
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li v-for="(phoneNumber, index) in filteredPhone" :key="index"
              ...
              <div class="mt-[30px]">
                <div class="flex gap-4">
                  <div class="max-w-3/6 w-full" v-bind:class="{ 'hidden lg:block': selectedCountry }">
                    ...
                    <p class="w-full text-end pr-[50px] pt-[10px] h-[26px]"></p>
                    <div
                      class="relative after:content-[''] after:w-[2px] after:absolute after:top-0 after:bottom-0 after:right-[1px] after:bg-[#DDE2E5]">
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li class="mr-[13px] rounded-[14px] border-gray-400 cursor-pointer"
                  ...
                  <div class="max-w-3/6 w-full" v-bind:class="{
                    ...
                    <p class="w-full text-end pr-14 lg:pr-[52%] pt-[10px] h-[26px]">Day</p>
                    <div
                      class="relative after:content-[''] after:w-[2px] after:absolute after:top-0 after:bottom-0 after:right-[1px] after:bg-[#DDE2E5]">
                      <ul class="mt-6 overflow-y-auto h-[491px] scrollbar">
                        <li
                          ...
                          <div v-if="selectedService?.name === service?.name &&
                            selectedService?.flag === service?.flag
                            " class="border border-gray-400 flex items-center py-[5px] px-[12px] rounded-[10px]">
                            <div @click="handleModalOpen(true)" class="flex items-center gap-[6px] pl-[3px]">
                              <span class="text-zinc-600 dark:text-[#F5F5F5] text-xs font-normal font-[Poppins]">Get
                                Now</span>
                              <svg class="darkIconStock" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                  d="M2.07371 8.31669C1.65461 6.36087 1.44506 5.38296 1.97038 4.73315C2.4957 4.08334 3.4958 4.08334 5.49602 4.08334H8.50378C10.504 4.08334 11.5041 4.08334 12.0294 4.73315C12.5547 5.38296 12.3452 6.36087 11.9261 8.31669L11.6761 9.48335C11.392 10.809 11.25 11.4718 10.7687 11.8609C10.2874 12.25 9.60952 12.25 8.25378 12.25H5.74602C4.39027 12.25 3.7124 12.25 3.23111 11.8609C2.74981 11.4718 2.60778 10.809 2.32371 9.48335L2.07371 8.31669Z"
                                  stroke="#495057" stroke-width="0.7" />
                                <path d="M4.66675 7H9.33342" stroke="#495057" stroke-width="0.7" stroke-linecap="round"
                                  stroke-linejoin="round" />
                                <path d="M5.83325 8.75H8.16659" stroke="#495057" stroke-width="0.7" stroke-linecap="round"
                                  stroke-linejoin="round" />
                                <path d="M10.5 5.25L8.75 1.75" stroke="#495057" stroke-width="0.7" stroke-linecap="round"
                                  stroke-linejoin="round" />
                                <path d="M3.5 5.25L5.25 1.75" stroke="#495057" stroke-width="0.7" stroke-linecap="round"
                                  stroke-linejoin="round" />
                              </svg>
                            </div>
                          </div>
          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <DialogPanel
              ...
              <div class="bg-neutral-50 dark:bg-[#09132C] px-[30px] pt-5 pb-0">
                <div class="">
                  <div v-if="selectedCountry" class="flex items-center border-b border-zinc-200 py-[16px]">
                    ...
                    <div class="flex gap-[6px] items-center w-2/4">
                      <!-- <img :src="PhilipinsImg" alt="Image Description" /> -->
                      <img :src="selectedCountry?.flag" class="w-[20px] h-[20px] rounded-full" alt="Flag" width="20" />
                  ...
                  <div v-if="selectedService" class="flex items-center border-b border-zinc-200 py-[16px]">
                    <div class="text-left text-zinc-600 dark:text-[#ACB5BD] text-sm font-medium font-[Poppins] w-2/4">
                      Service:
                    </div>
                    <div class="flex gap-[6px] items-center">
                  ...
                  <div v-if="selectedPhone && selectedWeek" class="flex items-center border-b border-zinc-200 py-[16px]">
                    <div class="text-left text-zinc-600 dark:text-[#ACB5BD] text-sm font-medium font-[Poppins] w-2/4">
                      Rent:
                    </div>
                    <div class="text-zinc-600 dark:text-[#ACB5BD] text-sm font-light font-[Poppins] w-2/4">
                ...
                <div class="justify-start items-start gap-5 inline-flex w-full">
                  <div @click="handleModalOpen(false)" ref="cancelButtonRef"
                    ...
                    <svg v-if="Theme === 'light'" width="14" height="11" viewBox="0 0 14 11" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path d="M13 5.5H1M1 5.5L5.5 1M1 5.5L5.5 10" stroke="#495057" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                    <svg v-if="Theme === 'dark'" width="14" height="11" viewBox="0 0 14 11" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path d="M13 5.5H1M1 5.5L5.5 1M1 5.5L5.5 10" stroke="#F5F5F5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    </svg>
                  ...
                  <RouterLink to="/payment"
                    ...
                    <svg class="darkIconStock" width="15" height="15" viewBox="0 0 15 15" fill="none"
                      ...
                      <path
                        ...
                        stroke="#0057FF" />
                      <path d="M5.1665 7.5H9.83317" stroke="#0057FF" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M6.3335 9.25H8.66683" stroke="#0057FF" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M11 5.75L9.25 2.25" stroke="#0057FF" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M4 5.75L5.75 2.25" stroke="#0057FF" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
