...
import Innovation from "../../assets/img/about/Innovation.png"
import teamwork from "../../assets/img/about/teamwork.png"
import Excellence from "../../assets/img/about/Excellence.png"
import Responsibility from "../../assets/img/about/Responsibility.png"
...
<template>
    <section>
        <div>
            <SectionHeader title="About our company" description="Lorem ipsum dolor sit amet consectetur adipiscing elit 
interdum ullamcorper sed pharetra sene." />
            ...
            <div class="px-4 pt-[60px] mx-auto sm:max-w-xl md:max-w-full lg:max-w-[1192px] md:px-24 lg:px-8 lg:pt-[84px]">
                <div class="flex flex-col lg:flex-row flex-wrap justify-start items-start gap-[14px] lg:gap-[100px]">
                    <h3 class="text-left lg:text-center w-full lg:w-[20%] text-neutral-800  dark:text-white text-xl lg:text-[32px] font-medium font-['Poppins'] leading-9">What

                        we do
                    </h3>
                    <div class="w-full lg:w-[65%]">
                        <p class="max-w-[808px] text-zinc-600  dark:text-white text-xl font-light font-['Poppins'] leading-[29.20px]">It is a
                            long
                        ...
                        <br>
                        <p class="max-w-[808px] text-zinc-600  dark:text-white text-xl font-light font-['Poppins'] leading-[29.20px]">
                ...
                <div class="flex  flex-col lg:flex-row justify-center items-center gap-[100px] mt-[187px] ">
                    <div class="max-w-[486px]">
                        <h3 class=" text-neutral-800  dark:text-white text-xl lg:text-[32px] font-medium font-['Poppins'] leading-9 pb-[24px]">Our
                            Mission</h3>
                        <p class=" text-zinc-600  dark:text-white text-xl font-light font-['Poppins'] leading-[29.20px]">Lorem ipsum dolor
                        ...
                        <br>
                        <p class=" text-zinc-600  dark:text-white text-xl font-light font-['Poppins'] leading-[29.20px]">
                ...
                <div class="mt-[100px] lg:mt-[194px] mb-[107px] lg:mb-[172px]">
                    <div class="flex flex-col justify-center items-center">
                        ...
                        <h3 class="max-w-[456px] text-center text-neutral-800  dark:text-white  text-2xl px-[25px] lg:px-0 lg:text-[32px] font-medium font-['Poppins'] leading-9 mb-[82px]">The
                    ...
                    <div class="flex flex-col lg:flex-row flex-wrap justify-center items-center gap-[80px]">
                        ...
                        >
                            ...
                            <div>
                                <h6 class="text-neutral-800  dark:text-white text-2xl font-medium font-['Poppins'] leading-relaxed">
                                    {{value.title}}</h6>
                                <p class=" text-zinc-600  dark:text-white text-base font-light font-['Poppins'] leading-normal">Long
                                    {{ value.description }}</p>
                            </div>
                        </div>
            ...
            valuesData: [
                {
                    ...
                    description: "Long established fact that a readeed to will be distracted by the readable content of a page when looking at its layout",
                },
                {
                    id: 2,
                    img: teamwork,
